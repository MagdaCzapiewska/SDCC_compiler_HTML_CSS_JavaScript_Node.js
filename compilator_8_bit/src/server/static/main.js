...
function submitAddFolder() {
    ...
    const xhttp = new XMLHttpRequest();
    xhttp.onload = function() {
        const {id: folder_id, name, parent_id} = JSON.parse(this.response);
...
function submitDeleteFolder() {
    ...
    const xhttp = new XMLHttpRequest();
    xhttp.onload = function() {
        const {id: folder_id} = JSON.parse(this.response);
...
function submitDeleteFile() {
    ...
    const xhttp = new XMLHttpRequest();
    xhttp.onload = function() {
        const {id: file_id} = JSON.parse(this.response);
